...
<div class="container">
    <div class="jumbotron">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <form  action="mark.action" method="get" >
                    <div class="panel panel-default">
                        <!-- Default panel contents -->
                        <div class="panel-heading">小组概要</div>
                        <!-- Table -->
                        <table class="table">
                            ...
                            <c:forEach var="team" items="${sessionScope.teamList}">
                                <tr>
                                    ...
                                    <td><input  name="chooseTeam" type="radio" value="${team.id}"/></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
        ...
        <s:textfield name="test" size="20"/>

        <form action="teaminfo.action" class="form-inline" role="form" method="post">
