...
<Script Language="JavaScript">
    function modify()
    {
        document.form1.action="modifystudent.action";
        document.form1.submit();
    }

    function delet()
    {
        document.form1.action="deletestudent.action";
        document.form1.submit();
    }
</Script>
...
<div class="container">
    <div class="jumbotron">
        ...
        <c:choose>
            <c:when test="${sessionScope.loginTeacher == null}">
                <form name="form1" action="" method="post">
                    ...
                    <button type="button" class="btn btn-primary" onclick="modify()" disabled="disabled">修改学生成绩</button>
                    <button type="button" class="btn btn-primary" onclick="delet()"  disabled="disabled">删除学生</button>
                </form>
            </c:when>
            <c:otherwise>
                <form name="form1" action="" method="post">
                        ...
                        <table class="table">
                            ...
                            <c:forEach var="student" items="${sessionScope.studentList}">
                                <tr>
                                    ...
                                    <td><input name="chooseStudent" type="radio" value="${ordinal}"/></td>
                                </tr>
        ...
        <hr/>
        <form action="addstudent.action" class="form-inline" role="form" method="post">
            <div class="form-group">
                <h2>添加组员信息</h2>
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon0">组号</span>
                    <input class="form-control" name="selectTeam" type="text" value="${sessionScope.teamSelected}" readonly="readonly"/>
                </div>
